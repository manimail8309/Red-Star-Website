      ...
      <div className="bg-white text-black pt-16 pb-6 px-10 rounded-t-[32px] rounded-b-[32px] w-full flex flex-col">
        <div className="flex flex-col md:flex-row mb-16 gap-10 md:gap-8 lg:gap-20">
          ...
          <div className="flex flex-col w-full md:w-[45%]">
            ...
            <div className="flex gap-4">
              <Link href="#" className="bg-[#222222] text-white p-2.5 rounded-lg flex items-center justify-center hover:bg-black transition-colors">
          ...
          <div className="flex flex-col w-full md:w-[35%] lg:w-[30%]">
            ...
            <div className="flex flex-col gap-4 text-[16px] text-gray-700 font-medium tracking-tight">
              ...
              <a href="mailto:redstarproductionshyd@gmail.com" className="flex items-center gap-4 hover:text-black transition-colors cursor-pointer w-fit">
                ...
                redstarproductionshyd@gmail.com
              </a>
              <a href="https://www.google.com/maps/search/?api=1&query=410,+Madhapur,+Hyderabad,+Telangana,+India" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 hover:text-black transition-colors cursor-pointer w-fit">
                ...
                <span>410, Madhapur, Hyderabad,<br />Telangana, India</span>
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm font-medium text-gray-600">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            >
              powered by Good2Great AI services.
            </a>
          </div>
        </div>
      </div>
